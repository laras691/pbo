...
urlpatterns = [
    ...
    path('admin/generate-laporan/', views.generate_laporan, name='generate-laporan'),
    ...
    path('admin/profil/', views.lihat_profil, name='lihat-profil'),
    path('admin/profil/edit/', views.edit_profil, name='edit-profil'),
    path('admin/profil/ganti-password/', views.ganti_password, name='ganti-password'),
